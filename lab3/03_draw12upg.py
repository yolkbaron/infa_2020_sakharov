...
# bushes
placebush(screen, (-10, 578), 0.23, mirror=False)
placebush(screen, (563, 667), 0.23, mirror=False)
placebush(screen, (516, 898), 0.6, mirror=False)
placebush(screen, (690, 607), 0.36, mirror=True)
placebush(screen, (679, 734), 0.6, mirror=True)
placebush(screen, (760, 1030), 0.32, mirror=True)
# animals
placekozjol(screen, (283, 465), 0.4, mirror=False)
placekozjol(screen, (172, 583), 0.4, mirror=False)
placekozjol(screen, (325, 639), 0.4, mirror=True)

placekozjol(screen, (665, 593), 1.2, mirror=True)
placekozjol(screen, (-280, 715), 2.2, mirror=False)
